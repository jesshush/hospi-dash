...
const HospitalDashboard = () => {
    ...
    const displayAlerts = [
        { drugName: 'Paracetamol', message: 'Expiring in 2 days' },
        { drugName: 'Ibuprofen', message: 'Expiring in 5 days' },
        { drugName: 'Insulin', message: 'Low Stock' },
        { drugName: 'Amoxicillin', message: 'Expiring in 15 days' },
        { drugName: 'Cetirizine', message: 'Expired' },
